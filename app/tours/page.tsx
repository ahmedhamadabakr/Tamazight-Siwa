    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-balance">Tours & Experiences</h1>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {tours.map((tour) => (
              <Card key={tour.id} className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-shadow">
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-4xl mx-auto text-center px-4">
          <div className="mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Need a Custom Experience?</h2>
